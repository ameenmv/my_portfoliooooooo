...
const _assets = {
  ["i18n:b2156a1b.json"]: {
    import: () => import('../raw/b2156a1b.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"99d-uTz8yrLle2Nnh8wjvGctnDr/fNs\"","mtime":"2026-09-24T23:11:08.838Z"}
  },
  ["i18n:f07b75af.json"]: {
    import: () => import('../raw/f07b75af.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"c0a-qZTCa0SvPoSy5oxZNMxz7LhPtRE\"","mtime":"2026-09-24T23:11:08.838Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7861465e-64e2-4450-8580-e4ea28d98fa6",
  ...
  en: [
    {
      ...
      load: () => readI18nAsset("b2156a1b.json"),
      cache: true
    }
  ],
  ar: [
    {
      ...
      load: () => readI18nAsset("f07b75af.json"),
      cache: true
    }
  ]
};
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"name":"theme-color","content":"#1f1d1d"},{"name":"author","content":"Ameen Mohamed"},{"property":"og:type","content":"website"},{"property":"og:site_name","content":"Ameen Mohamed"},{"property":"og:title","content":"Ameen Mohamed — Front-End Engineer"},{"property":"og:description","content":"Front-End Engineer specializing in Vue.js, Nuxt.js, real-time systems, and interactive web experiences."},{"property":"og:url","content":"https://ameeen.me"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"Ameen Mohamed — Front-End Engineer"},{"name":"twitter:description","content":"Front-End Engineer specializing in Vue.js, Nuxt.js, real-time systems, and interactive web experiences."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/brand/logo-ameen.svg"},{"rel":"canonical","href":"https://ameeen.me"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const _6TKfA4BJvfO50oM8y348FygQgP_2RDRX4eEnNIBfeA = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _6TKfA4BJvfO50oM8y348FygQgP_2RDRX4eEnNIBfeA
];
...
const _DyOII0 = _messagesHandlerCached;

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_staJKB = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_staJKB, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _DyOII0, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_staJKB, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withQuery as A, withTrailingSlash as B, withoutTrailingSlash as C, sanitizeStatusCode as D, baseURL as E, getRequestURL as F, defu as G, getRequestHeader as H, getCookie as I, klona as J, withBase as K, isEqual as L, createDefu as M, parsePath as N, setCookie as O, deleteCookie as P, listener as Q, appRootTag as a, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, encodePath as e, appSpaLoaderAttrs as f, appId as g, defineRenderHandler as h, appTeleportTag as i, appTeleportAttrs as j, getQuery as k, createError$1 as l, appHead as m, destr as n, getRouteRules as o, publicAssetsURL as p, joinURL as q, getResponseStatusText as r, getResponseStatus as s, useNitroApp as t, useRuntimeConfig as u, hasProtocol as v, parseQuery as w, parseURL as x, decodePath as y, isScriptProtocol as z };
